...
import logging
logger = logging.getLogger('tilegen_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by TilegenWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseTilegenWindow object.
        """
        builder = get_builder('TilegenWindow')
        new_object = builder.get_object("tilegen_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a TilegenWindow object with it in order to finish
        initializing the start of the new TilegenWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.tilegen")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('tilegen')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for tilegen."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for tilegen."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the TilegenWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the TilegenWindow is closed."""
